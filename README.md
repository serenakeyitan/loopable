...
![you: "ugh, the tests keep flaking again" — claude (loopable ↻): "you can run: /goal all tests pass and lint is clean, stop after 20 turns"](docs/media/what-is-loopable.svg)
